...
$python_exec -m accelerate.commands.launch ./src/align_your_latents_controls_gen/align_latents_train_control_gen.py --yaml_config_file_name ./src/align_your_latents_controls_gen/config_files/run_on_regular_dataset_control_gen.yml