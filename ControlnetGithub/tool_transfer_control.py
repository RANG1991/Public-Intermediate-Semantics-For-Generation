path_sd15 = 'ControlnetGithub/models/v1-5-pruned.ckpt'
path_sd15_with_control = 'ControlnetGithub/models/control_sd15_openpose.pth'
path_input = 'ControlnetGithub/models/anything-v3-full.safetensors'
path_output = 'ControlnetGithub/models/control_any3_openpose.pth'
...
import torch
from ControlnetGithub.cldm.model import load_state_dict
