...
from ControlnetGithub.annotator.uniformer.mmcv.cnn import ConvModule, normal_init
from ControlnetGithub.annotator.uniformer.mmcv.ops import point_sample

from ControlnetGithub.annotator.uniformer.mmseg.models.builder import HEADS
